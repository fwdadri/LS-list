...
document.getElementById('login').addEventListener('submit', function (event){
    ...
    //se uso un btn submi por eso se scrribio event.preventDefault();
       ...
       var reCorreo = document.getElementById('correoLo').value;
       var rePassword = document.getElementById('contrasenaLo').value;    
       ...
       if (loCorreo == '' && loPassword == '') {
         ...
         alert('ingrese correo y contraseña')
           ...
           let userExist = users.some(user => user.correo === CorreoLo && user.contrasena === PasswordLo);
